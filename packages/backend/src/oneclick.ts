...
export const ONECLICK_ENUMS = {
  ...
  cucina: ['abitabile', 'angolo cottura', 'cucinotto', 'semiabitabile', 'assente'],
  riscaldamento: ['autonomo', 'centralizzato', 'assente'],
  disponibilita: ['libero', 'occupato', 'nuda proprietà', 'affittato', 'libero al rogito'],
  tipo_riscaldamento: ['assente', 'stufa', 'caldaia', 'termoconvettore', 'pompa di calore', 'a pannelli radianti', 'pannelli solari', 'termosifone', 'term. con contabilizzatore'],
